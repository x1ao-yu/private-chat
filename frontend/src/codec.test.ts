...
describe("codec", () => {
  ...
  it("encodes and decodes all message types", () => {
    const msgs = [
      ...
      { type: "key_update", channelId: "abc123", payload: "iv.mid.ct" },
      { type: "set_room_name", channelId: "abc123", payload: "iv.mid.ct" },
      { type: "set_nickname", channelId: "abc123", payload: "iv.mid.ct" },
      ...
      { type: "key_updated", channelId: "abc123", payload: "iv.mid.ct", from: "peer-1", self: true },
      { type: "room_name_updated", channelId: "abc123", payload: "iv.mid.ct", from: "peer-1", self: false },
      { type: "nickname_updated", channelId: "abc123", payload: "iv.mid.ct", from: "peer-1", self: false },
