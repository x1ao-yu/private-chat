...
P0 基础已完成，P1 最小化聊天已完成，P2 端到端加密已完成，P3 房间密钥已完成，P4 隐私已完成，P5 安全已完成，P6 匿名身份已完成。P7：标准化群组协议评估已完成 —— MLS 引入暂缓，详见 `docs/mls-evaluation.md`（当前不声称具备 FS/PCS，见 SECURITY.md "P7 Notes"）。
